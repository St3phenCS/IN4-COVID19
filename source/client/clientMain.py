...
class MainUI(QDialog):
    def __init__(self, parent=None):
        ...
        self.searchbox.setPlaceholderText("Input to search")
        ...
        self.result_box_intro.setText(
            ...
            <span style="font-size: 20px; line-height: 20px;">The covid tracker app</span><br/>
            <span style="font-size: 15px; line-height: 15px;">By NTC team</span><br/>
            <span style="font-size: 12px; line-height: 12px;"><br>From FIT@HCMUS VNU-HCM with love ♥</span>
        """
        )
